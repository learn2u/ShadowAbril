...
Imports System.Xml
Public Class frVerArticulosPed
    Private Sub frVerArticulosPed_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dgArticulos.Columns(3).Visible = True
        ...
        dgArticulos.Columns(6).FillWeight = 50
        dgArticulos.Columns(6).MinimumWidth = 50
        dgArticulos.Columns(6).Visible = True
